...
const generatePrompt = (prompt:String) => {
    ...
    El texto recibido es: \n${prompt}\n\n
        **Primero Paso:** Verifica si el texto recibido sigue la estructura (número,texto), si no responde: "Por favor, cumple con la estructura número, texto.

        **Segundo Paso:** Quiero que el numero lo transformes a binario y cuentes las vocales.

        **Tercer Paso:** Devuelve el resultado en el formato: "Binario,vocales". 
        - Por ejemplo: Si el número es "8" y el texto es "Cine", la respuesta debe ser "101, 2 vocales".
